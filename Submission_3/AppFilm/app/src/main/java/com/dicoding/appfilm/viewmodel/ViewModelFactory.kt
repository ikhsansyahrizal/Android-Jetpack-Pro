...
import com.dicoding.appfilm.ui.favorite.FavMovieViewModel
import com.dicoding.appfilm.ui.favorite.FavTvShowViewModel
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(FavMovieViewModel::class.java) -> {
                FavMovieViewModel(mFilmRepository) as T
            }

            modelClass.isAssignableFrom(FavTvShowViewModel::class.java) -> {
                FavTvShowViewModel(mFilmRepository) as T
            }
